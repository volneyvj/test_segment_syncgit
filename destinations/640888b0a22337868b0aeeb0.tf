import {
  to = segment_destination.id-640888b0a22337868b0aeeb0
  id = "640888b0a22337868b0aeeb0"
}

resource "segment_destination" "id-640888b0a22337868b0aeeb0" {
  enabled = false
  metadata = {
    contacts = [
      {
