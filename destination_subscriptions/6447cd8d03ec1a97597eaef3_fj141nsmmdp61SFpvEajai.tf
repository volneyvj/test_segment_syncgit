import {
  to = segment_destination_subscription.id-6447cd8d03ec1a97597eaef3_fj141nsmmdp61SFpvEajai
  id = "6447cd8d03ec1a97597eaef3:fj141nsmmdp61SFpvEajai"
}

resource "segment_destination_subscription" "id-6447cd8d03ec1a97597eaef3_fj141nsmmdp61SFpvEajai" {
  action_id      = "5DAMQ5qUaF2rZoyVNiReCa"
  destination_id = "6447cd8d03ec1a97597eaef3"
  enabled        = true
  model_id       = null
  name           = "Contact"
