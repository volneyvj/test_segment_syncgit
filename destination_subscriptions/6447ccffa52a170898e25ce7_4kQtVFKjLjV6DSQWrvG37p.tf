import {
  to = segment_destination_subscription.id-6447ccffa52a170898e25ce7_4kQtVFKjLjV6DSQWrvG37p
  id = "6447ccffa52a170898e25ce7:4kQtVFKjLjV6DSQWrvG37p"
}

resource "segment_destination_subscription" "id-6447ccffa52a170898e25ce7_4kQtVFKjLjV6DSQWrvG37p" {
  ...
  trigger        = "event = \"Salesforce Professional\" and type = \"track\""
}