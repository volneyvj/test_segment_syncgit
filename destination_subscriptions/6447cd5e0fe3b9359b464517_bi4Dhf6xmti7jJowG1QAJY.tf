import {
  to = segment_destination_subscription.id-6447cd5e0fe3b9359b464517_bi4Dhf6xmti7jJowG1QAJY
  id = "6447cd5e0fe3b9359b464517:bi4Dhf6xmti7jJowG1QAJY"
}

resource "segment_destination_subscription" "id-6447cd5e0fe3b9359b464517_bi4Dhf6xmti7jJowG1QAJY" {
  action_id      = "5DAMQ5qUaF2rZoyVNiReCa"
  destination_id = "6447cd5e0fe3b9359b464517"
  enabled        = true
  model_id       = null
  name           = "Contact"
