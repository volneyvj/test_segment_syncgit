import {
  to = segment_user.id-vV2KdewwzpayUKg2jsMb6X
  id = "vV2KdewwzpayUKg2jsMb6X"
}

resource "segment_user" "id-vV2KdewwzpayUKg2jsMb6X" {
  email = "jtyrrell@twilio.com"
  permissions = [
    {
      resources = [
        {
    ...
    },
    {
      ...
      role_id = "1Mc8DKQ95UMoCKw1y9syxModCaC"
    },
    {
      resources = [
        {
